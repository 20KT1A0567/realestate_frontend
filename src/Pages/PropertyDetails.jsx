...
const PropertyDetails = () => {
  ...
  useEffect(() => {
    const fetchPropertyDetails = async () => {
      try {
        ...
        const propertyResponse = await fetch(`https://demo-deployment-latest-3.onrender.com/api/properties/${id}`, {
          method: "GET",
  ...
  const handleRatingSubmit = async () => {
    try {
      ...
      const response = await fetch("https://demo-deployment-latest-3.onrender.com/ratings", {
        method: "POST",
        headers: {
